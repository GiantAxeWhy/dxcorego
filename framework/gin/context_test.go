...
import (
	...
	testdata "github.com/GiantAxeWhy/dxcorego/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/GiantAxeWhy/dxcorego/framework/gin.handlerNameTest$", c.HandlerName())
}
